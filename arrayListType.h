...
public:
    ...
    //position specified by location
    //Returns the value of the item at location
    //Postcondition: If location is out of range program is terminated.
    ...
    //Function to remove all occurrences of removeItem from the list.
    //Note that this is an abstract function.
    //Postcondition: If one or more occurrences of removeItem are found in the list,
    //               they are removed from the list and length is decremented by
